...
export class UpdateBitDto {
  @ApiProperty({ example: 'Einkaufen gehen', description: 'Kurzer Text, der die Aufgabe beschreibt', required: false })
  titel?: string;

  @ApiProperty({ example: 1, description: 'Status: 0=offen, 1=in Bearbeitung, 2=erledigt', required: false })
  status?: number;
